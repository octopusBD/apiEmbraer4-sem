            ...
            <v-table width="800" height="450" style="margin: 60 auto; border-spacing: 10px; margin:30px;">
                <thead>
                    <tr class="cabecalho" style="background-color: #333333;">
                        ...
                        <th style="color: white;">Incorporated</th>
                        <th style="color: white;">Not Incorporated </th>
                        <th style="color: white;">Applicable</th>
                    ...
                    <tr v-for="(item, index) in paginatedItems" :key="index">
                        ...
                        <v-checkbox v-model="item.isChassi"></v-checkbox>
                        </td>
                        <td style="border-bottom: 1px solid black;">
                        <v-checkbox v-model="item.isIncorporado"></v-checkbox>
                        </td>
                        <td style="border-bottom: 1px solid black;">
                        <v-checkbox v-model="item.isNaoIncorporado"></v-checkbox>
                        </td> 
                    </tr>
                    </tbody>
                    </v-table>
